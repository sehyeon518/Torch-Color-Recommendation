...
model.load_state_dict(torch.load(r'color_classification\Classification\Model\model.pt'))
model.eval()
...
def main():
    ...
    image_path = r'C:\Users\mlfav\lib\shlee\Images\product_images\kahi.jpg'
    ...
    list_of_colors_path = r'color_classification\jsonl\list_of_colors.jsonl'
    ...
    _, top_predictions = torch.topk(output, k=4)
    prediction_colors = [metadata_colors[c].tolist() for c in top_predictions]

...
json_file_path = r'C:\Users\mlfav\lib\shlee\Favorfit-Color-Recommendation\color_classification\jsonl\72030_palettes.jsonl'
new_file_path = r'C:\Users\mlfav\lib\shlee\Favorfit-Color-Recommendation\color_classification\jsonl\train.jsonl'

with open(json_file_path, 'r') as list_of_colors:
    list_of_colors_data = [json.loads(line) for line in list_of_colors]

count = [0 for _ in range(540)]
...
for data in list_of_colors_data:
    ...
    data['input_data'] = sum((palette_RGB, palette_HSV, palette_LAB,
    ...
    data['input_data'] = sum(data['input_data'], [])
    data['output_color'] = bg_number
